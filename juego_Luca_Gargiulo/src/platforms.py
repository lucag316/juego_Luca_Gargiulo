...
class Platform(pygame.sprite.Sprite):
    def __init__(self, path_imagen: str, posicion: tuple, size: tuple) -> None:
    ...
    def render(self, screen: pygame.Surface):     # poner en todas render o en todas draw
        ...
        if DEBUG:
            ...
            pygame.draw.rect(screen, GREEN, self.rect_right, 2)
            pygame.draw.rect(screen, GREEN, self.rect_left, 2)
            pygame.draw.rect(screen, GREEN, self.rect_top, 2)
            pygame.draw.rect(screen, GREEN, self.rect_bottom, 2)
