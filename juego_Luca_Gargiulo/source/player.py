...
#     def __init__(self, size: tuple, posicion_inicial: tuple, velocidad) -> None:
#         super().__init__()
#         self.indice = 0
...
# def aplicar_gravedad(self):
    ...
    #         self.contador_pasos = 0
    #     self.image = accion[self.contador_pasos]    #pantalla.blit(accion[self.contador_pasos], self.rect)
