...
#         self.player = Player(PATH_IMAGE_PLAYER, SIZE_PLAYER, START_POS_PLAYER)
#         self.sprites.add(self.player) # aparece el sprite en la pantalla, fijarse la forma mejor con mi propio metodo
...
#         self.player = Player(SIZE_PLAYER, START_POS_PLAYER)
#         self.sprites.add(self.player) # aparece el sprite en la pantalla, fijarse la forma mejor con mi propio metodo
...
#         #self.menu = Menu(pygame.display.set_mode(SIZE_SCREEN), PATH_IMAGE_BACKGROUND)
